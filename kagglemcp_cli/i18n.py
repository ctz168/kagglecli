#!/usr/bin/env python3
"""i18n module for KaggleMCP CLI - supports English (default) and Chinese.

Usage:
    import i18n
    i18n.t('loading_notebook', name='notebook.ipynb')

Set the language via the KAGGLEMCP_LANG environment variable (e.g. 'zh'),
or at runtime via i18n.set_lang('zh').
"""

import os

# Default language loaded from environment (English unless KAGGLEMCP_LANG=zh)
...
TRANSLATIONS = {
    'en': {
        ...
        'version': 'kagglemcp-cli version {version}',
        ...
        # ============ Server side (kaggle_server.py response messages) ============
    ...
    'zh': {
        ...
        'version': 'kagglemcp-cli 版本 {version}',
