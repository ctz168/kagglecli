...
class RemoteExecutionEngine(ExecutionEngine):
    """
    Execute notebook cells on a remote KaggleMCP server with streaming output.
    ...
    def sync_state(self) -> Dict[str, Any]:
        ...
        if "error" not in status:
            self._execution_state["current_directory"] = status.get("current_directory", "/kaggle/working")
